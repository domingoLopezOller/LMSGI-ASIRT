  ...
  setId({startId: start, endId: end})
    ...
    <div className="App">
      ...
      <div className="generation-btns">
        ...
        <Button className='button' onClick={() => updateGen(650,721)} >Gen 6</Button>
        <Button className='button' onClick={() => updateGen(722,809)} >Gen 7</Button>
        <Button className='button' onClick={() => updateGen(810,905)} >Gen 8</Button>
        <Button className='button' onClick={() => updateGen(906,1010)} >Gen 9</Button>
      </div>
